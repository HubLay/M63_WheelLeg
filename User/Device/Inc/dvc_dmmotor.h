 ...
 *
 */
class Class_DM_Motor_8009P
{
public:
    friend class Class_Leg;
    ...
    void Offline_Callback_Function();
...
protected:
    ...
    void Data_Process();
    void Set_Output_Torque(float __Output_Torque);              //只有友元才能使用该函数，防止别的乱改
};
 ...
 */
float Class_DM_Motor_8009P::Get_Now_Angle()
{
 ...
 */
float Class_DM_Motor_8009P::Get_Now_Omega()
{
 ...
 */
float Class_DM_Motor_8009P::Get_Now_Torque()
{
 ...
 */
float Class_DM_Motor_8009P::Get_Now_MOS_Temperature()
{
 ...
 */
float Class_DM_Motor_8009P::Get_Now_Rotor_Temperature()
{
 ...
 */
Enum_DM_Motor_Control_Method Class_DM_Motor_8009P::Get_Control_Method()
{
 ...
 */
float Class_DM_Motor_8009P::Get_MIT_K_P()
{
    return (MIT_K_P);
}
 ...
 */
float Class_DM_Motor_8009P::Get_MIT_K_D()
{
    return (MIT_K_D);
}
 ...
 */
float Class_DM_Motor_8009P::Get_Target_Angle()
{
    return (Target_Angle);
}
 ...
 * @return float 目标的速度
 */
float Class_DM_Motor_8009P::Get_Target_Omega()
{
    return (Target_Omega);
}
 ...
 * @return float 目标的扭矩
 */
float Class_DM_Motor_8009P::Get_Target_Torque()
{
 ...
 * @return float 
 */
inline float Class_DM_Motor_8009P::Get_Transform_Angle()
{
 ...
 * @return float 
 */
inline float Class_DM_Motor_8009P::Get_Transform_Omega()
{
 ...
 */
void Class_DM_Motor_8009P::Set_DM_Motor_Control_Method(Enum_DM_Motor_Control_Method __Control_Method)
{
    DM_Motor_Control_Method = __Control_Method;
}

inline void Class_DM_Motor_8009P::Set_DM_Motor_Control_Alg(Enum_DM_Motor_Control_Alg __DM_Motor_Control_Alg)
{
 ...
 */
void Class_DM_Motor_8009P::Set_MIT_K_P(float __MIT_K_P)
{
    MIT_K_P = __MIT_K_P;
}
 ...
 */
void Class_DM_Motor_8009P::Set_MIT_K_D(float __MIT_K_D)
{
    MIT_K_D = __MIT_K_D;
}
 ...
 */
void Class_DM_Motor_8009P::Set_Target_Angle(float __Target_Angle)
{
 ...
 */
void Class_DM_Motor_8009P::Set_Target_Omega(float __Target_Omega)
{
 ...
 */
void Class_DM_Motor_8009P::Set_Target_Torque(float __Target_Torque)
{
 ...
 */
inline void Class_DM_Motor_8009P::Set_Transform_Angle(float __Transform_Angle)
{
 ...
 * @param __Target_Torque 
 */
inline void Class_DM_Motor_8009P::Set_Transform_Omega(float __Transform_Omega)
{
