...
//理论上三个电机应该是同一个父类生成，然后基层加
/**
 * @brief 电机离线保护操作
 *
 */
static void GM6020_Offline_Callback_Function(void *Param)
{
    Class_DJI_Motor_GM6020 *Instance = (Class_DJI_Motor_GM6020 *)Param;
    Instance->Offline_Callback_Function();
}
 ...
 *
 */
static void C610_Offline_Callback_Function(void *Param)
{
    Class_DJI_Motor_C610 *Instance = (Class_DJI_Motor_C610 *)Param;
    Instance->Offline_Callback_Function();
}
 ...
 *
 */
static void C620_Offline_Callback_Function(void *Param)
{
    Class_DJI_Motor_C620 *Instance = (Class_DJI_Motor_C620 *)Param;
    Instance->Offline_Callback_Function();
}
...
void Class_DJI_Motor_GM6020::Init(FDCAN_HandleTypeDef *hcan, Enum_DJI_Motor_ID __CAN_ID, Enum_DJI_Motor_Control_Method __DJI_Motor_Control_Method, int32_t __Encoder_Offset, float __Omega_Max)
{
    ...
    Daemon_Init_Config_s Daemon_Init_Config_Ins = Get_DaemonInitConfig_s(10, this, GM6020_Offline_Callback_Function);
 ...
 * @brief 电机离线操作
 */
void Class_DJI_Motor_GM6020::Offline_Callback_Function()
{
...
void Class_DJI_Motor_C610::Init(FDCAN_HandleTypeDef *hcan, Enum_DJI_Motor_ID __CAN_ID, Enum_DJI_Motor_Control_Method __DJI_Motor_Control_Method, float __Gearbox_Rate, float __Torque_Max)
{
    ...
    Daemon_Init_Config_s Daemon_Init_Config_Ins = Get_DaemonInitConfig_s(10, this, C610_Offline_Callback_Function);
    daemon_instance = DaemonRegister(Daemon_Init_Config_Ins);
}
 ...
 * @brief 电机离线操作
 */
void Class_DJI_Motor_C610::Offline_Callback_Function()
{
...
void Class_DJI_Motor_C620::Init(FDCAN_HandleTypeDef *hcan, Enum_DJI_Motor_ID __CAN_ID, Enum_DJI_Motor_Control_Method __DJI_Motor_Control_Method, float __Gearbox_Rate, float __Torque_Max)
{
    ...
    Daemon_Init_Config_s Daemon_Init_Config_Ins = Get_DaemonInitConfig_s(10, this, C620_Offline_Callback_Function);
    daemon_instance = DaemonRegister(Daemon_Init_Config_Ins);
}
 ...
 * @brief 电机离线操作
 */
void Class_DJI_Motor_C620::Offline_Callback_Function()
{
...
void Class_DJI_Motor_C620::TIM_PID_PeriodElapsedCallback()
{
    ...
    {
        //默认闭环扭矩控制
        Out = Target_Torque * 16384.0f / ((15.765 * 0.3f * 20.0f)/ 19.2032f);
        Math_Constrain(&Out, -16384.0f, 16384.0f);
    }
    break;
    case (DJI_Motor_Control_Method_OMEGA):
