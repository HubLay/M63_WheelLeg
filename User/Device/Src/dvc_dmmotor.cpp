 ...
 *
 */
static void DM8009P_Offline_Callback_Function(void *Param)
{
    Class_DM_Motor_8009P *Instance = (Class_DM_Motor_8009P *)Param;
 ...
 */
void Class_DM_Motor_8009P::Init(FDCAN_HandleTypeDef *hcan, Enum_DM_Motor_ID __CAN_ID, Enum_DM_Motor_Control_Method __Control_Method, int32_t __Position_Offset, float __Omega_Max, float __Torque_Max)
{
 ...
 *
 */
void Class_DM_Motor_8009P::Data_Process()
{
    //数据处理过程
    ...
    //计算电机本身信息
    Data.Now_Angle = (float)tmp_position / (float)Position_Max * 2.0f * PI;                                 //上位机-PI -- PI，在这里偏移到了0 -- 2 * PI
...
void Class_DM_Motor_8009P::Set_Output_Torque(float __Output_Torque)
{
    Output_Torque = __Output_Torque;
}
 ...
 *
 */
void Class_DM_Motor_8009P::TIM_Process_PeriodElapsedCallback()
{
...
void Class_DM_Motor_8009P::Compensite_Out(float Compensite_Value)
{
