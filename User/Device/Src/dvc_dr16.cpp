...
void DR16_Offline_Function(void *Param){
...
void Class_DR16::Init(UART_HandleTypeDef *huart_1,UART_HandleTypeDef *huart_2)
{
    ...
    Daemon_Init_Config_s Daemon_Init_Config = Get_DaemonInitConfig_s(50, this, DR16_Offline_Function);
    daemon_instance = DaemonRegister(Daemon_Init_Config);
}
